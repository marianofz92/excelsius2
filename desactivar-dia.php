...
<!--             <li><a href="editar-perfil-paciente.php"><span class="glyphicon glyphicon-edit"></span>Editar perfil</a></li>-->
    ...
    <h1>Desactivar horarios: Por día.</h1>
     ...
     <div class="alert alert-danger">
        <strong>Aviso:</strong> Una vez desactivado los horarios, los pacientes no podrán acceder a los turnos de los mismos.</p>
     </div>
     
    <div class="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3"> 
    <div class="panel panel-default" id="formulario">
    <div class="panel-heading">Seleccione un día</div>
    ...
    <form class="formulario-dia"  method="get" id="formulario_dia" action="desactivar-tabla.php">
      ...
      <br>
      <br>
      <input type="submit" value="VER" class="btnconsulta btn btn-primary"  id="btnconsultar" >
